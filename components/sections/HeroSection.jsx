  ...
  return (
    <section id="home" className="h-dvh w-full">
      <Image
        ...
        height={400}
        priority
        className="absolute left-1/2 top-[75px] h-[50vh] w-auto translate-x-[calc(-50%+22.5px)] rotate-12 md:top-[155px] md:translate-x-[calc(-50%+45px)]"
      />

      <h1 className="h1-title pt-[70vh] xs:mb-4 md:pt-[75vh]">
        Im Targonsky <br className="sm:hidden" />
        Mykyta.
      </h1>

      <p className="mt-3 text-lg leading-6 tracking-[-2px] xs:text-center md:mt-5 md:text-xl">
        Im a{" "}
